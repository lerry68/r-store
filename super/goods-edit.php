            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Edit Goods</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.php" class="text-muted">Dashboard</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="goods.php" class="text-muted">Goods</a>
                                    </li>
                                    <li class="breadcrumb-item active" aria-current="page"><strong>Edit Goods</strong>
                                    </li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="card">
                            <div class="card-body">
                                <a href='goods.php' class='btn btn-success'><i class='fa fa-arrow-left'></i> Back</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit Goods Form</h4>
                                <hr>
                                <form class="pl-3 pr-3" action="../processes/goods-edit.php" method="POST">
                                    <?php
                                    $goodsCode = $_GET['goods_code'];
                                    $data = showGoods($goodsCode);
                                    ?>
                                    <input type="hidden" name="goodsCode" value='<?php echo $goodsCode ?>'>
                                    <div class="form-group">
                                        <label for="goodsCode">Goods Code</label>
                                        <input class="form-control" type="text" id="goodsCode" name="goodsCode" value='<?php echo $goodsCode ?>' disabled placeholder="The Goods Code">
                                    </div>
                                    <div class="form-group">
                                        <label for="goodsName">Goods Name</label>
                                        <input class="form-control" type="text" id="goodsName" name="goodsName" value='<?php echo $data['goods_name'] ?>' required placeholder="(Max.40 Characters)">
                                    </div>
                                    <div class="form-group">
                                        <label for="goodsPrice">Goods Price</label>
                                        <input class="form-control" type="number" id="goodsPrice" name="goodsPrice" value='<?php echo $data['goods_price'] ?>' required placeholder="in Rupiah (ex.125000)">
                                    </div>
                                    <div class="form-group">
                                        <label for="goodsStock">Goods Stock</label>
                                        <input class="form-control" type="number" id="goodsStock" name="goodsStock" value='<?php echo $data['stock'] ?>' required placeholder="The stock of Goods">
                                    </div>
                                    <hr>
                                    <div class="text-center">
                                        <button class="btn btn-rounded btn-secondary" type="reset">Reset</button>
                                        <button class="btn btn-rounded btn-primary" type="submit" name="btnUpdate">Submit</button>
                                    </div>
                                </form>
                            </div>
                        </div>
