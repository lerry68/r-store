                                        ...
                                        <tbody>
                                            ...
                                            foreach ($allGoods as $goods) {
 		                                    ...
 		                                    <tr>
                                                ...
                                                <td>$goodsPrice</td>
                                                <td>$stock</td>
                                                <td><a href='goods-edit.php?goods_code=$goods[goods_code]' class='btn btn-rounded btn-secondary text-white' type='submit' style='font-size: 15px; margin-top: -7px;'><i class='fa fa-edit'></i> Edit</a>
                                                 | 
                                                <a href='../processes/goods-delete.php?goods_code=$goods[goods_code]' onclick=\"return confirm('Are you sure want to remove this Items?')\" class='btn btn-rounded btn-danger text-white' type='submit' style='font-size: 15px; margin-top: -7px;'><i class='fa fa-trash'></i> Delete</a></td>
                                            </tr>";
                                            } ?>
                                        </tbody>
                                    </table>
