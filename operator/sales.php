...
//ambil data dari tabel detailbarang berdasarkan username
$allGoods = indexGoods();
$goodsTotal = count($allGoods);
//hasil pencarian di tabel barang
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="../assets/images/users/operator.png" alt="user" class="rounded-circle" width="40">
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item active"> <a class="sidebar-link sidebar-link" href="sales.php" aria-expanded="false"><i data-feather="file-text" class="feather-icon"></i><span class="hide-menu">Transactions</span></a>
                        </li>
                        <br>
                        <li class="list-divider"></li>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Sales Transactions</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.php" class="text-muted">Dashboard</a>
                                    </li>
                                    <li class="breadcrumb-item active" aria-current="page"><strong>Transactions</strong>
                                    </li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4>Transaction Date : <?php echo $date; ?></h4>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <hr>
                                <form action="../processes/sales.php" method="POST">
                                    <div class="form-body">
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="goodsCode" class=" form-control-label">Code</label></div>
                                            <div class="col col-md-9">
                                                <div class="input-group">
                                                    <input type="text" id="goodsCode" name="goodsCode" placeholder="Goods Code" class="form-control" value="<?php echo "$result[goods_code]"; ?>">
                                                    <div class="input-group-btn"><button class="btn btn-secondary" name="searchBtn"><i class="fa fa-search"></i> SEARCH</button></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="goodsName" class=" form-control-label">Name</label></div>
                                            <div class="col-12 col-md-9"><input type="text" id="goodsName" name="" placeholder="Goods Name" value="<?php echo $result['goods_name']; ?>" class="form-control" readonly>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="goodsPrice" class=" form-control-label">Price</label></div>
                                            <div class="col-12 col-md-9"><input type="text" id="goodsPrice" name="" placeholder="Goods Price" class="form-control" value="<?php echo $resultRp = formatRp($result['goods_price']); ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="goodsStock" class=" form-control-label">Stock</label></div>
                                            <div class="col-12 col-md-9"><input type="text" id="goodsStock" name="" placeholder="Goods Stock" class="form-control" value="<?php error_reporting(0);
                                                                                                                                                                            echo $result['stock']; ?>" readonly>
                                            </div>
                                        </div>
                                        <div class="row form-group">
                                            <div class="col col-md-3"><label for="goodsQty" class=" form-control-label">Quantity</label></div>
                                            <div class="col-12 col-md-9"><input type="number" id="goodsQty" name="goodsQty" placeholder="Goods Qty" class="form-control">
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                    <div class="form-actions">
                                        <div class="text-center">
                                            ...
                                            <button type="submit" class="btn btn-primary" name="addBtn"><i class="fa fa-plus"></i> ADD</button>
                                        </div>
                                    </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <table id="zero_config" class="table table-striped table-bordered display no-wrap text-center" style="width:100%">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($data as $goods) {
                                                ...
                                                $total += $subtotal;
                                                $goodsPriceRp = formatRp($goodsPrice);
                                                $subtotalRp = formatRp($subtotal);
                                                $totalRp = formatRp($total);
                                                echo "
 		                                    <tr>
                                                <td>$goodsCode</td>
                                                <td>$goodsName</td>
                                ...
                                <div class="form-actions">
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-primary" name="submitBtn"><i class="fa fa-upload"></i> SUBMIT</button>
                                    </div>
                                </div>
                                </form>
                            </div>
