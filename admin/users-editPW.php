                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="users-edit.php" class="text-muted">Edit Users</a>
                                    </li>
                                    <li class="breadcrumb-item active" aria-current="page"><strong>Change Password</strong>
                                    </li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="card">
                            <div class="card-body">
                                <a href='javascript:history.back()' class='btn btn-success'><i class='fa fa-arrow-left'></i> Back</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="card-body">
                                ...
                                <form class="pl-3 pr-3" action="../processes/users-edit.php" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="password" id="password" name="password" required placeholder="Input the new password">
                                    </div>
                                    <div class="form-group">
                                        <label for="password2">Re-type Password</label>
                                        <input class="form-control" type="password" minlength="5" maxlength="11" id="password2" name="password2" required placeholder="Re-type the new password">
                                    </div>
                                    <hr>
                                    <div class="text-center">
                                        <button class="btn btn-rounded btn-secondary" type="reset">Reset</button>
                                        <button class="btn btn-rounded btn-primary" type="submit" name="btnUpdatePW">Submit</button>
                                    </div>
                                </form>
                            </div>
                        </div>
