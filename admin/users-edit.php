            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Edit Users</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.php" class="text-muted">Dashboard</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="users.php" class="text-muted">Users</a>
                                    </li>
                                    <li class="breadcrumb-item active" aria-current="page"><strong>Edit</strong>
                                    </li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-2">
                        <div class="card">
                            <div class="card-body">
                                <a href='users.php' class='btn btn-success'><i class='fa fa-arrow-left'></i> Back</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <hr>
                                <form class="pl-3 pr-3" action="../processes/users-edit.php" method="POST">
                                    <?php
                                    $id = $_GET['id'];
                                    $data = showUser($id);
                                    ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="name" name="name" value='<?php echo $data['name'] ?>' required placeholder="Enter your clear name">
                                    </div>
                                    <div class="form-group">
                                        <label for="username">Username</label>
                                        <input class="form-control" type="text" minlength="5" maxlength="11" id="username" name="username" value='<?php echo $data['username'] ?>' required placeholder="(Unique Max.11 Characters)">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="role" required>
                                            ...
                                            <option value="operator" default>OPERATOR</option>
                                        </select>
                                    </div>
                                    <div class="form-group text-right">
                                        <a href='users-editPW.php?id=<?php echo $id; ?>' class='btn btn-danger'><i class='fa fa-edit'></i> Change Password</a>
                                    </div>
                                    <hr>
