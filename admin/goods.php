                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="javascript:void(0)" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="../assets/images/users/admin.png" alt="user" class="rounded-circle" width="40">
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="sales.php" aria-expanded="false"><i data-feather="file-text" class="feather-icon"></i><span class="hide-menu">Transactions</span></a>
                        </li>
                        <li class="sidebar-item active"> <a class="sidebar-link sidebar-link" href="goods.php" aria-expanded="false"><i data-feather="file-text" class="feather-icon"></i><span class="hide-menu">Goods</span></a>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="users.php" aria-expanded="false"><i data-feather="file-text" class="feather-icon"></i><span class="hide-menu">Users</span></a>
                        </li>
                        <br>
                        <li class="list-divider"></li>
                        <br><br><br><br>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Manage Goods</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.php" class="text-muted">Dashboard</a>
                                    </li>
                                    <li class="breadcrumb-item active" aria-current="page"><strong>Goods</strong>
                                    </li>
                                </ol>
                            </nav>
                        </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Add new Goods</h4>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header modal-colored-header bg-primary">
                                                <h3 class="modal-title" id="primary-header-modalLabel">Add new Goods Form
                                                </h3>
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                            </div>
                                            <div class="modal-body">
                                                <form class="pl-3 pr-3" action="../processes/goods-add.php" method="POST">
                                                    <div class="form-group">
                                                        <label for="goodsCode">Goods Code</label>
                                                        <input class="form-control" type="text" maxlength="6" id="goodsCode" name="goodsCode" required placeholder="(Unique 6 Characters)">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="goodsName">Goods Name</label>
                                                        <input class="form-control" type="text" id="goodsName" name="goodsName" required placeholder="(Max.40 Characters)">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="goodsPrice">Goods Price</label>
                                                        <input class="form-control" type="number" id="goodsPrice" name="goodsPrice" required placeholder="in Rupiah (ex.125000)">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="goodsStock">Goods Stock</label>
                                                        <input class="form-control" type="number" id="goodsStock" name="goodsStock" required placeholder="The stock of Goods">
                                                    </div>
                                ...
                                <div class="btn-list">
                                    <!-- Custom width modal -->
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#primary-header-modal"><i class="fa fa-plus"></i> Add Items</button>
                                </div>
                            </div> <!-- end card-body-->
                        </div> <!-- end card-->
                    </div> <!-- end col-->
