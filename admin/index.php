...
<body>
        ...
        <aside class="left-sidebar" data-sidebarbg="skin6">
            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="sidebar-item active"> <a class="sidebar-link sidebar-link" href="index.php" aria-expanded="false"><i data-feather="home" class="feather-icon"></i><span class="hide-menu">Dashboard</span></a>
                        </li>
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item active" aria-current="page"><strong>Dashboard</strong>
                                    </li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <p class="card-title lead text-center"><span id="dt"></span></p>
                                        <div class="jumbotron">
                                            <h1 class="display-4">Hello <?php echo $name ?>!<br>You are logged in as an <em><?php echo $role ?></em></h1>
                                            <hr class="my-4">
                                            <p>As an <em><?php echo $role ?></em> you can :</p>
                                            <div class="col-lg-7">
                                                <ul class="list-style-none">
                                                    <li><i class="fa fa-check text-info"></i> Remove items from Transactions</li>
                                                    <li><i class="fa fa-check text-info"></i> Adding new Goods</li>
                                                    <li><i class="fa fa-check text-info"></i> Manage Users (OPERATORs)</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script type="text/javascript">
        ...
        function dt() {
            ...
            e.innerHTML = myDays[day] + ', ' + date + ' ' +
                myMonths[month] + ' ' + year + ' - ' + hour + ':' + minute + ':' + second;
