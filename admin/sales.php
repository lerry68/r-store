            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="nav-small-cap active"><span class="hide-menu">Menus</span></li>
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($data as $goods) {
 		                                    ...
 		                                    <tr>
                                                ...
                                                <td>$goodsQty</td>
                                                <td>$subtotalRp</td>
                                                <td><a href='../processes/goods-remove.php?id=$goods[id]' onclick=\"return confirm('Are you sure want to remove this Items?')\" class='btn btn-rounded btn-danger text-white' type='submit' style='font-size: 15px; margin-top: -7px;'><i class='fa fa-trash'></i> Remove</a></td>
                                            </tr>";
                                            } ?>
                                        </tbody>
                                        <tfoot>
